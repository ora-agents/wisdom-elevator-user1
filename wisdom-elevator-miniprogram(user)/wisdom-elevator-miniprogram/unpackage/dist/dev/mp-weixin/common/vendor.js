...
function initRuntimeSocketService() {
  const hosts = "192.168.22.118,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_eNQRdX";
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), T = b, C = I('{"address":["127.0.0.1","192.168.22.118"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX.5.07.2026041006/HBuilderX/plugins/unicloud/**/*.js"]}'), P = I('[{"provider":"aliyun","spaceName":"wisdom-elevator","spaceId":"mp-83744ff1-8956-4c57-83b7-6ed45fb9fc9a","clientSecret":"2OmiUQU3eWDP8YY6dFwuig==","endpoint":"https://api.next.bspapp.com","failoverEndpoint":""}]') || [];
let E = "";
try {
  E = "__UNI__803655C";
} catch (e2) {
